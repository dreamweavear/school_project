 ...
 if ($conn->connect_error){
   ...
   $sql="INSERT INTO `tbl_feedback` (`feedback_id`, `feedback_name`, `feedback_email`, `message`, `status`, `date`) 
	VALUES ('', '$feedname', '$feedemail', ' $message', '0', CURRENT_TIMESTAMP)"; 
...
//$result = mysql_query("SELECT s_id FROM `tbl_studetails` WHERE `first_name`=$fname");
 ...
 //echo $feedname, $feedemail ,$message;
...
<h1><i><b><center>Feedback Submitted </center></b></i></h1>
